...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        Analytics.sharedInstance.trackScene("GameScene")
    }
...
extension GameScene {
    ...
    private func enemyDidRunOutOfLifePointsEventHandler() -> DidRunOutOfHealth {
    ...
    private func playerDidRunOutOfLifePointsEventHandler() -> DidRunOutOfHealth {
